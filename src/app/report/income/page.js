...
import ViewIncome from '@/Component/report/income/view';
import EditIncome from '@/Component/report/income/edit';
import DeleteIncome from '@/Component/report/income/delete';
import CreateIncome from '@/Component/report/income/create';
...
const rows = [
  createData(1,"Website Subscription","Software",10000,"Yes","Active"),
  createData(2,"Consultation Fee","Service",15000,"No","Active"),
  createData(3,"Online Course","Education",5000,"Yes","Active"),
  createData(4,"Advertisement","Marketing",8000,"No","Inactive")
];
  ...
  <div>
    ...
    <CommonDialog
          ...
          dialogContent={
            openData ? (
              <CreateIncome open={openData} handleCreate={handleCreate} handleClose={handleClose} />
            ) : viewShow ? (
              <ViewIncome viewData={ViewData} handleClose={handleClose}  />
            ) : editShow ? (
              <EditIncome
                editData={editData}
