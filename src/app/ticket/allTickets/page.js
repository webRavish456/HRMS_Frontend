...
import { EditOutlined, DeleteOutlined, VisibilityOutlined, Add, Search, FilterList, Download } from "@mui/icons-material";
...
export default function AllTickets() {
  ...
  const handleEdit = (ticket, index) => { setSelectedTicket(ticket); setSelectedIndex(index); setEditShow(true); };
