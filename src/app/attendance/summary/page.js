...
export default function AttendanceSummary() {
  ...
  return (
    <Box sx={{ padding: "1.5rem", backgroundColor: "#f8fafc", minHeight: "100vh" }}>
      ...
      {/* Users Section with Carousel in Card */}
      <Card sx={{
      ...
      <Box sx={{ marginBottom: "2rem" }}>
        ...
        <Stack direction="row" spacing={1} sx={{ flexWrap: "wrap", gap: 1 }}>
          {timeFilters.map((filter) => (
            <Button
              key={filter}
              variant={selectedPeriod === filter ? "contained" : "outlined"}
              ...
              sx={{
                ...
                paddingY: "0.5rem",
                fontSize: "0.875rem",
                backgroundColor: selectedPeriod === filter ? "#3b82f6" : "transparent",
                color: selectedPeriod === filter ? "white" : "#6b7280",
                borderColor: selectedPeriod === filter ? "#3b82f6" : "#d1d5db",
                "&:hover": {
                  backgroundColor: selectedPeriod === filter ? "#2563eb" : "#f3f4f6",
                  borderColor: selectedPeriod === filter ? "#2563eb" : "#9ca3af"
                }
              }}
            >
              {filter}
        ...
        <Grid container spacing={2}>
          <Grid size={{xs:12, sm:6, md:3}}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              ...
              <Typography variant="body2" sx={{ color: "#6b7280" }}>
                Regular: {attendanceMetrics.regular} Days
              </Typography>
            </Box>
          </Grid>
          <Grid size={{xs:12, sm:6, md:3}}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              ...
              <Typography variant="body2" sx={{ color: "#6b7280" }}>
                Early: {attendanceMetrics.early} Days
              </Typography>
            </Box>
          </Grid>
          <Grid size={{xs:12, sm:6, md:3}}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              ...
              <Typography variant="body2" sx={{ color: "#6b7280" }}>
                Late: {attendanceMetrics.late} Days
              </Typography>
            </Box>
          </Grid>
          <Grid size={{xs:12, sm:6, md:3}}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              ...
              <Typography variant="body2" sx={{ color: "#6b7280" }}>
                On leave: {attendanceMetrics.onLeave} Days
              </Typography>
            </Box>
          </Grid>
        </Grid>
