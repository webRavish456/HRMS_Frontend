...
const EditEmployeePage = () => {
  ...
  useEffect(() => {
    // In real app, fetch employee data by ID from API and populate form
    setFormData({
      firstName: sampleEmployeeData.fullName,
      email: sampleEmployeeData.email,
      phone: sampleEmployeeData.phone,
      experience: sampleEmployeeData.experience,
      dateOfBirth: sampleEmployeeData.dateOfBirth,
      qualification: sampleEmployeeData.qualification,
      currentAddress: sampleEmployeeData.address,
      gender: sampleEmployeeData.gender,
      branchName: sampleEmployeeData.branchName,
      department: sampleEmployeeData.department,
      basicSalary: sampleEmployeeData.basicSalary,
      specialization: sampleEmployeeData.specialization,
      joiningDate: sampleEmployeeData.joinDate,
      accountHolderName: sampleEmployeeData.accountHolderName,
      accountNumber: sampleEmployeeData.accountNumber,
      bankName: sampleEmployeeData.bankName,
      ifscCode: sampleEmployeeData.ifscCode,
      bankBranch: sampleEmployeeData.bankBranch,
      branchLocation: sampleEmployeeData.branchLocation,
    });
  }, [params.id]);
