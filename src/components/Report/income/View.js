  ...
  return (
    <Grid container spacing={2}>
      <Grid size={{xs:12, sm:6}}>
        <Typography variant="subtitle2" sx={{ fontWeight: 600 }}>Income ID:</Typography>
      ...
      <Grid size={{xs:12, sm:6}}>
        ...
        <Typography sx={{ color: "#059669", fontWeight: 600 }}>₹{selectedData.amount.toLocaleString()}</Typography>
      </Grid>
      <Grid size={{xs:12, sm:6}}>
