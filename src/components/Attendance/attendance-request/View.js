  ...
  return (
    <Grid container spacing={3}>
      <Grid size={{xs:12, md:6}}>
        ...
        <Box sx={{ marginBottom: 2 }}>
          <Typography variant="body2" sx={{ fontWeight: 600, color: "#6b7280" }}>Request Type</Typography>
          <Typography variant="body1">{selectedData.requestType}</Typography>
        </Box>
        <Box sx={{ marginBottom: 2 }}>
      ...
      <Grid size={{xs:12, md:6}}>
        ...
        <Box sx={{ marginBottom: 2 }}>
          <Typography variant="body2" sx={{ fontWeight: 600, color: "#6b7280" }}>Total Hours</Typography>
          <Typography variant="body1">{selectedData.totalHours}</Typography>
        </Box>
        <Box sx={{ marginBottom: 2 }}>
